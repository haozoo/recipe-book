    ...
    <div className='flex flex-col h-screen'>
      ...
      <main className='flex flex-grow'>
        ...
        <div className='flex-1 h-full bg-chrome-yellow'>
          <Container>
            <div className='inline-block my-auto align-center'>
              ...
              <p className='font-nunito text-white text-2xl'>
                Cooking is now made easy with <span className='font-patrick italic text-hazelnut text-3xl'>REcipes</span>, your cooking companion!
              </p>
              <span className='inline-block text-2xl align-center'>
                ...
                <span className='text-white font-nunito text-xl pl-2'>to store your recipes for free!</span>
              </span>
              <p>OR</p>
              <button type="button" class="text-chestnut bg-white hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium font-nunito rounded-lg text-xl px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
