        ...
        <div className='flex-1 h-full bg-chrome-yellow'>
          <Container>
            <div className='py-48 inline-block my-auto align-content'>
              ...
              <button onClick={handleGoogleLogin} type="button" class="text-chestnut bg-white hover:bg-white/90 focus:ring-4 focus:outline-none focus:ring-white/50 font-medium font-nunito rounded-lg text-xl px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
