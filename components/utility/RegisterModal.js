                            ...
                            <form action="#" method="POST" className="space-y-6">
                              ...
                              <div className="flex space-x-4">
                                ...
                                {/*<button
                                  ...
                                  className="flex w-full justify-center rounded-md border border-1 border-chrome-yellow py-2 px-4 text-lg font-medium text-chrome-yellow shadow-sm focus:outline-none focus:ring-2 focus:ring-hazelnut focus:ring-offset-2"
                                >
                                  SIGN IN
                                </button>*/}
                              </div>
